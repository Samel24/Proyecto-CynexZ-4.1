                        ...
                        <div className="cabecera">
                            ...
                            <div className="contenido">
                                ...
                                <div className="generos">
                                    <h3 className="letra-amarillo">Generos: </h3>
                                    {
                                        generos.map((genero) => (
                                ...
                                <h4 className="letra-amarillo">Fecha de Lanzamiento: <b className={modo ? "letra-blanca" : "letra-negra"}>{pelicula.release_date}</b></h4>
                            </div>
                        </div>
